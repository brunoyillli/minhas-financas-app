...
class ConsultaLancamentos extends React.Component {
    ...
    buscar = () => {
        ...
        this.service.consultar(lancamentoFiltro)
            .then(resposta => {
                ...
                messages.mensagemErro('Ocorreu um erro ao tentar consultar os lancamentos')
            })
    }
    ...
    deletar = () => {
        this.service.deletar(this.state.lancamentoDeletar.id).then(response => {
            ...
            messages.mensagemErro('Ocorreu um erro ao tentar deletar um lancamento')
        })
    }
                    ...
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <button onClick={this.preparaFormularioCadastro}
                                type="button" className="btn btn-danger"><i className="pi pi-plus"></i> Cadastrar</button>
                        </div>
                    </div>
                </div>
                <br />
